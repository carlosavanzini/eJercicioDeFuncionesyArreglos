...
// let agregar = prompt("Ingrese el nombre");
// meses.push(agregar);

// meses.forEach((element) => {
//   document.write(`Los meses son los siguientes ${element}`);
// });
...
while (confirm('Quiere ingresar una ciudad')) {
    let agregar= prompt('Ingresar la ciudad')
